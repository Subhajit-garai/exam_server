...
//   private redisclient: QueueManager;
...
//     this.redisclient = QueueManager.getInstance();
...
// //       let { examid, examtype } = data.payload;
// //       let examptternId = await this.Network.getExamPatternId(examid);
// //       let exampattern: exam_pattern = await this.Network.getExamPattern(
// //         examptternId
// //       );
// //       if (!exampattern) {
...
// //         // get formated syllabus
// //         if (!syllabusid) {
// //           throw Error("exam pattern's syllabusid not found ");
// //         }

// //         let syllabus_data: (string | null)[] =
// //           await this.Network.getSyllabusDataForExamCreattion(syllabusid);
...
// //       let { examid, userid } = data.payload;
...
// //         let { chatid, userid, cburl, platform, chat_type } = Data;
...
// //                 let groupData = await this.Network.telegramgroupinfo(chatid);
...
// //                     name: string;
// //                     topicId: number;
// //                   } | null = await this.Network.telegramGroupTopicInfo(
// //                     chatid,
// //                     "quiz"
// //                   );
...
// //           let quizConfig = await this.Network.getQuizConfigData(
// //             chatid,
// //             platform,
// //             userid
// //           );
...
// //           let finalquestions = await this.Network.getQuestions_byIds(
// //             Question_array
// //           );
// //           if (finalquestions) {
