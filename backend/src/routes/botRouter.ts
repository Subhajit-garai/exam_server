...
import { examQuestionAddedCompletionStatusCheck, getExamDetails, getQuestionViaIds, getSyllabusDataForExamCreattion, processNotification, setUserProgress } from "@/controllers/bot.controller";
import { getUserScore, setUserScore } from "@/controllers/bot/bot.score.controller";
import { getExamAns, getUserans, SetUserans } from "@/controllers/bot/bot.ans.controller";
import { getExamPattern, getExamPatternid, getMockSetExamPattern, updatExamCrationStatus } from "@/controllers/bot/bot.exampattern.controller";
import { addQuestions, getQuestions, getQuestionsByids, getQuestionsIds } from "@/controllers/bot/bot.question.controller";
import { getQuizConfigdData, getQuizTopic, sentQuizData } from "@/controllers/bot/bot.quiz.controller";
import { AllUserData, bot_login, isGroupJoinable, IsprimeUser, sendAlluser, sendGroupinfo, sendGroupTopicinfo, sendValidchatids } from "@/controllers/bot/bot.telegram.controller";
