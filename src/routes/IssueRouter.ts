...
import { CloseIssue, createNewIssue, getAllIssue, getIssueByid, Isprocessed_issue, setDownVote, setPriorityVote, setupVote, update_issue, GetquestionIssuecount } from "../controllers/issue.controller.js";
