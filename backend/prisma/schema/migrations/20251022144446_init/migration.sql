...
-- CreateEnum
CREATE TYPE "ExamStatus" AS ENUM ('DRAFT', 'UPCOMING', 'ONGOING', 'COMPLETED', 'ARCHIVED');
...
CREATE TABLE "TargetExam" (
    ...
    "shortCode" TEXT,
    "description" TEXT,
    "examType" "ExamScope" NOT NULL DEFAULT 'NATIONAL',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "mock_question_map" (
    "id" TEXT NOT NULL,
    "number" INTEGER NOT NULL DEFAULT 0,
    "questionid" TEXT NOT NULL,
    "part" TEXT NOT NULL DEFAULT 'part1',
...
-- CreateIndex
CREATE UNIQUE INDEX "Syllabus_exam_year_id_key" ON "Syllabus"("exam_year_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "Subject_target_exam_id_key" ON "Subject"("target_exam_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "mock_question_map_id_key" ON "mock_question_map"("id");

-- CreateIndex
CREATE INDEX "mock_question_map_mockid_idx" ON "mock_question_map"("mockid");

-- CreateIndex
CREATE UNIQUE INDEX "mock_question_map_mockid_questionid_part_key" ON "mock_question_map"("mockid", "questionid", "part");
...
-- AddForeignKey
ALTER TABLE "botQuizConfig" ADD CONSTRAINT "botQuizConfig_quiz_topic_id_fkey" FOREIGN KEY ("quiz_topic_id") REFERENCES "botQuizTopic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "botQuizTopic" ADD CONSTRAINT "botQuizTopic_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "botQuizTopic" ADD CONSTRAINT "botQuizTopic_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "Subject"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "botQuizTopic" ADD CONSTRAINT "botQuizTopic_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "Topic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "mock_question_map" ADD CONSTRAINT "mock_question_map_mockid_fkey" FOREIGN KEY ("mockid") REFERENCES "mock_questions_set"("id") ON DELETE SET NULL ON UPDATE CASCADE;
