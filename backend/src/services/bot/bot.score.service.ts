...
export class BotScoreService {
    ...
    async updateUserProgress(userid: string, lastExamid: string, examType: ExamType) {
        // Use centralized ProgressService
        // examType is fetched inside updateExamProgress to ensure consistency with DB
        const progressService = new ProgressService();
        await progressService.updateExamProgress(userid, lastExamid);
    }
