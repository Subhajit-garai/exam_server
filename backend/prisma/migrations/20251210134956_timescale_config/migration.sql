...
-- Retention Policy: Drop raw data older than 1 month (Minimizes storage)
SELECT add_retention_policy('timescale_score', INTERVAL '1 month');
-- Retention Policy for Aggregates: Keep exactly 4 years of history
SELECT add_retention_policy('user_score_summary_week', INTERVAL '4 years');
SELECT add_retention_policy('user_score_summary_month', INTERVAL '4 years');
SELECT add_retention_policy('subject_score_summary_week', INTERVAL '4 years');
SELECT add_retention_policy('subject_score_summary_month', INTERVAL '4 years');
