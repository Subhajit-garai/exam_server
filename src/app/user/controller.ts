...
export const generateEmailValidationToken = asyncHandler(
...
export const verifyUserEmailValidationToken = asyncHandler(
  async (req: any, res: any) => {
    ...
    const userId = await userService.verifyUserEmailValidationToken(
      token,
      email,
    );
...
export const generateUserTelegramIdValidationToken = asyncHandler(
  async (req: any, res: any) => {
    ...
    await userService.generateUserTelegramIdValidationToken(
      req.user,
      telegramid,
    );
...
export const verifyUserTelegramIdValidationToken = asyncHandler(
  async (req: any, res: any) => {
    let processedData = validateTokenZodSchema.safeParse(req.body);
...
export const generateUserForgotPasswordToken = asyncHandler(
  async (req: any, res: any) => {
...
export const verifyUserForgotPasswordToken = asyncHandler(
  async (req: any, res: any) => {
...
export const getUserSubscriptionDetails = asyncHandler(
  async (req: any, res: any) => {
