...
import { checkoutToken, checkoutSubcription, getSubcriptionAndOffer, ApplyCoupon } from "../controllers/payment.controller.js";
...
paymentRouter.post("/apply-coupon", IsPurchasesOpen, IsCouponOpen, ApplyCoupon);