...
export const questionInputZodSchema = z.object({
  ...
  format: z.enum(examformat.enumValues),
...
export const questionUpdateZodSchema = z.object({
  ...
  format: z.enum(examformat.enumValues).optional(),
  ...
  difficulty: z.enum(diffcultlevel.enumValues).optional(),
  status: z.enum(Status.enumValues).optional(),
...
export const QuestionFilterDataFetchZodSchema = z.object({
  ...
  difficulty: z.enum(diffcultlevel.enumValues).optional(),
  format: z.enum(examformat.enumValues).optional(), // Fixed typo from formate
  status: z.enum(Status.enumValues).optional(),
  ismultipleans: z
    .string()
