...
import { ActivityService, activity_time_range } from "../services/activity.service.js";
...
export const getXPLeaderboard = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json({ success: true, data, message: "XP leaderboard fetched" });
});
...
export const getQuizLeaderboard = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json({ success: true, data, message: "Quiz leaderboard fetched" });
});
...
export const getStreakLeaderboard = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json({ success: true, data, message: "Streak leaderboard fetched" });
});
